...
REQUIRED = [
    ...
    'scripts/build_agentpack.py','scripts/doctor.py','scripts/validate_link_bootstrap.py','scripts/validate_behavior_contract.py','scripts/validate_skillpack_registry.py','scripts/validate_language_policy.py','scripts/validate_archive_policy.py','scripts/validate_profile_recipe.py','scripts/validate_inventory_contract.py','scripts/validate_profile_setup_tool.py','scripts/reset_launchroom_test_profile.ps1','scripts/install_launchroom_profile.ps1',
