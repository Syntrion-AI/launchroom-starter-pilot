---
name: launchroom-cloudroom-readiness
description: Use when LaunchRoom Full-System Bootstrap v0.7 needs cloudroom readiness as a public LaunchRoom skill for a real project-builder setup.
version: 0.7.0
author: Hermes Agent
license: MIT
metadata:
...
Use this skill during LaunchRoom setup when the current stage needs cloudroom readiness as part of turning an empty or poorly configured Hermes install into a working engineering SaaS profile factory.
