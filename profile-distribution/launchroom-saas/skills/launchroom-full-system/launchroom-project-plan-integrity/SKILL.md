...
Use this skill during LaunchRoom setup when the current stage needs project plan integrity as part of turning an empty or poorly configured Hermes install into a working engineering SaaS profile factory.
