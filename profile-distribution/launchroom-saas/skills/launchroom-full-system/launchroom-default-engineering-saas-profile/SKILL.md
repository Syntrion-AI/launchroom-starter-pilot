---
name: launchroom-default-engineering-saas-profile
description: Use when LaunchRoom Full-System Bootstrap v0.7 needs default engineering saas profile as a public LaunchRoom skill for a real project-builder setup.
version: 0.7.0
author: Hermes Agent
license: MIT
metadata:
...
# Default Engineering Saas Profile
...
Use this skill during LaunchRoom setup when the current stage needs default engineering saas profile as part of turning an empty or poorly configured Hermes install into a working engineering SaaS profile factory.
